...
public partial class DB_Crop : BGEntity
{
	...
	private static readonly DB_Human.Factory _factory1_PFS = new DB_Human.Factory();
	private static readonly DB_GroundLand.Factory _factory2_PFS = new DB_GroundLand.Factory();
	private static readonly DB_GroundStore.Factory _factory3_PFS = new DB_GroundStore.Factory();
	private static readonly DB_Player.Factory _factory4_PFS = new DB_Player.Factory();
	private static readonly DB_General.Factory _factory5_PFS = new DB_General.Factory();
	private static readonly DB_Language.Factory _factory6_PFS = new DB_Language.Factory();
	private static readonly DB_Act.Factory _factory7_PFS = new DB_Act.Factory();
